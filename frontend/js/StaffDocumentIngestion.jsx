      ...
      >
        <div className="w-full max-w-[640px] flex flex-col items-center">
          ...
          <div
            ...
            className={`w-full aspect-[1/1.414] min-h-[580px] bg-white rounded shadow-sm border border-[#E5E0D8] relative overflow-hidden flex items-center justify-center ${
          ...
          {isPreviewActive && (
            <p className="text-[11px] text-[#9E9689] mt-2 font-light">
              💡 คลิกเมาส์ค้างเพื่อลากเลื่อนดูเอกสาร (Pan & Drag)
            </p>
          )}
        </div>
      </div>
