...
export function DocumentPreviewModal({ document: doc, isOpen, onClose }) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="max-w-2xl text-white space-y-1 pr-4 cursor-default" onClick={(e) => e.stopPropagation()}>
      ...
      {/* True Portrait A4 Ratio */}
      <div className="flex-1 flex items-center justify-center p-4 min-h-0 relative cursor-pointer overflow-hidden" onClick={onClose}>
        <div
      ...
      {/* Bottom Control Bar with Centered Counter */}
      <div
      ...
      >
        <div className="flex items-center gap-2 sm:gap-3 z-10">
          <button
            ...
            disabled={zoom <= 50}
            className="hover:text-white px-2.5 py-1 rounded hover:bg-white/15 transition cursor-pointer disabled:opacity-30 text-base font-medium"
          >
            -
          </button>
